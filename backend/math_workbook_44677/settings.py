"""
Django settings for math_workbook_44677 project.
...
ROOT_URLCONF = 'math_workbook_44677.urls'
...
WSGI_APPLICATION = 'math_workbook_44677.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "math_workbook_44677 API",
    "DESCRIPTION": "API documentation for math_workbook_44677 App",
    "VERSION": "v1",
}
